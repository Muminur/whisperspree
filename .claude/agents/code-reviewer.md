---
name: code-reviewer
description: Reviews WhisperSpree diffs after each task and at milestone R-gates. Use proactively after the implementer finishes. Checks conformance to docs/PRD.md requirement IDs, §11 structure, §12 privacy rules, and repository process rules.
...
no telemetry, mic lifecycle); (4) §11 file placement; (5) repository process
